...
public class Method {
    ...
    public static void main(String[] args) {
        ...
        //Hello,World 메세지 출력 3번 출력
        for (int i = 1; i <= 2; ++i) {
            System.out.println("Hello, World");
        }

        //Hello,World 메세지 출력 3번 출력을 3번 반복
        for (int i = 1; i <= 2; ++i) {
            System.out.println("Hello, World");
        }
        for (int i = 1; i <= 2; ++i) {
        ...
        //Hello,World 메세지 출력 3번 출력을 3번 반복하는 코드에서
        //메세지 변경함 : Hello, Java
        //Hello, World를 Hello, Java로 바꿈
    ...
    //간단한 인사말 출력 메서드
    //public : 접근제한자, 외부 클래스가 이 메서드 사용허가 여부
    ...
    public static void computeAllSum2 (int a, int b) {
